...
Download the driver [jar file](https://github.com/axibase/atsd-jdbc/releases/download/RELEASE-1.2.18/atsd-jdbc-1.2.18-DEPS.jar) with dependencies and add it to the classpath of your application.

```
* Unix: java -cp "atsd-jdbc-1.2.18-DEPS.jar:lib/*" your.package.MainClass
* Windows java -cp "atsd-jdbc-1.2.18-DEPS.jar;lib/*" your.package.MainClass
```
